final class NetworkPath {
  ...
  static String deletePayment(String paymentId) =>
      '$baseUrl/payments/$paymentId';
  static String createPayment() => '$baseUrl/payments';
  static String refundPayment(String paymentId) =>
      '$baseUrl/payments/$paymentId/refunds';
  static String paymentPrediction() => '$baseUrl/predict';
  static String postReceiver() => '$baseUrl/receivers';
  static String paymentMethods(String id) =>
      '$baseUrl/merchants/$id/paymentMethods';
}
